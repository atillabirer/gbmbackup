...
const getNumberOfAuctions = async () => await gettersContract.methods.getTotalNumberOfSales().call();
...
async function getAuctionInfoMinimal(saleID) {
    ...
    return {
      ...
      gbmPresetName: await gettersContract.methods.getGBMPreset_Name(gbmPresetIndex).call(),
    }
}
